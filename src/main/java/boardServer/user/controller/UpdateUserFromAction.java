...
import boardServer.user.module.UserDao;
import boardServer.user.module.UserRequestDto;
import boardServer.user.module.UserResponseDto;

/**
 * Servlet implementation class UpdateUserFromAction
 */
public class UpdateUserFromAction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateUserFromAction() {
        super();
